...
describe('Beat Mix Problem Set - script.js file', () => {
  ...
  describe('clear() function', () => {
    ...
    it('should perform no array mutation when called with no arguments', () => {
      ...
      clear();
      expect(kicks).to.be.deep.equal(trueArray);
      expect(snares).to.be.deep.equal(trueArray);
      expect(hiHats).to.be.deep.equal(trueArray);
      expect(rideCymbals).to.be.deep.equal(trueArray);
    });
    ...
    it('mutates only a single array at a time', () => {
      ...
      const trueArray = new Array(16).fill(true);
      clear('kicks');
      expect(kicks).to.be.not.deep.equal(trueArray);
      expect(snares).to.be.deep.equal(trueArray);
      expect(hiHats).to.be.deep.equal(trueArray);
      expect(rideCymbals).to.be.deep.equal(trueArray);
    });
    ...
    it('should set all values in an array to false when called with a valid array name', () => {
      ...
      clear('kicks');
      expect(kicks).to.be.deep.equal(falseArray);
      clear('snares');
      expect(snares).to.be.deep.equal(falseArray);
      clear('hiHats');
      expect(hiHats).to.be.deep.equal(falseArray);
      clear('rideCymbals');
      expect(rideCymbals).to.be.deep.equal(falseArray);
    });
  ...
  describe('invert() function', () => {
    ...
    it('mutates only a single array at a time', () => {
      const falseArray = new Array(16).fill(false);
      invert('kicks');
      expect(kicks).to.be.not.deep.equal(falseArray);
      expect(snares).to.be.deep.equal(falseArray);
      expect(hiHats).to.be.deep.equal(falseArray);
      expect(rideCymbals).to.be.deep.equal(falseArray);
    });
